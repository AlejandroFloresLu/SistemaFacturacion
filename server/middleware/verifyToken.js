 ...
 * Si es válido, adjunta req.user = { id, username, rol } y llama a next().
 * Si es inválido o ausente, responde 401 Unauthorized.
 */
...
function verifyToken(req, res, next) {
    ...
    try {
        ...
        req.user = decoded; // { id, username, rol, iat, exp }
        next();
    } catch (err) {
